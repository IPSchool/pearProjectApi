   ...
   /* public function index11()
    {
        ...
        $data = request_only('recycle,archive,all');
    ...
    {
        $data = request_only('name,description,templateCode');
    ...
    {
        $data = request_only('name,description,cover,private,prefix,open_prefix,schedule,open_begin_time,open_task_private,task_board_theme,begin_time,end_time,auto_update_schedule');
