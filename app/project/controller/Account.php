...
//        $where = [['organization_code', '=', $currentOrganizationCode], ['is_owner', '=', 0]];
        $params = request_only('account,mobile,email,searchType,keyword');
...
//            $data['authorize'] = implode(',', json_decode($params['auth']));
    ...
    public function add()
    {
        ...
        $params = request_only('account,mail,mobile,desc,password,realname,name');
        if ($params['password']) {
    ...
    public function edit()
    {
        ...
        $params = request_only('mobile,email,desc,name,position,code,description');
    ...
    public function forbid()
    {
        ...
        $params = request_only('status,accountCode');
