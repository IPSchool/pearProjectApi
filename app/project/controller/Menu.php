...
class Menu extends BasicApi
{
    ...
    public function menuAdd()
    {
        ...
        $data = request_only('title,url,icon,is_inner,pid,status,sort,params,values,node,show_slider,file_path');
        if (!$data['file_path']) {
    ...
    {
        $data = request_only('title,url,icon,is_inner,id,params,sort,values,node,show_slider,file_path');
    ...
    {
        $this->success('', $this->model->_edit(request_only('status,id')));
    }
